/* eslint-disable */
import { z } from 'zod'
import { UpdateUserInput, UpdateTennisTeamInput, UpdatePointSystemInput, UpdateGroupInput, SignupInput, SendMessageInput, LoginInput, LineupSlotType, LineupVisibility, LineupSlotInput, LineupInput, CreateTennisTeamInput, MatchType, UpdateTeamLeaguePointSystemInput, CreateTeamLeaguePointSystemInput, RsvpStatus, CreateRsvpInput, Winner, ResultType, CreateGroupInput, ChangePasswordInput, UpdateTennisLeagueInput, UpdateTeamMatchInput, UpdateIndividualSinglesMatchInput, UpdateIndividualDoublesMatchInput, CreateTennisLeagueInput, CreateTeamMatchInput, CreateIndividualSinglesMatchInput, CreateIndividualDoublesMatchInput, CreateEventInput, BlockUserInput } from 'zod'
...
export const UpdatePointSystemInputSchema: z.ZodObject<Properties<UpdatePointSystemInput>> = z.object({
...
export const UpdateTeamLeaguePointSystemInputSchema: z.ZodObject<Properties<UpdateTeamLeaguePointSystemInput>> = z.object({
    drawPoints: z.number().nullish(),
    lossPoints: z.number().nullish(),
...
export const CreateTeamLeaguePointSystemInputSchema: z.ZodObject<Properties<CreateTeamLeaguePointSystemInput>> = z.object({
    drawPoints: z.number().nullish(),
    lossPoints: z.number().nullish(),
...
export const UpdateTennisLeagueInputSchema: z.ZodObject<Properties<UpdateTennisLeagueInput>> = z.object({
    description: z.string().nullish(),
...
export const UpdateIndividualSinglesMatchInputSchema: z.ZodObject<Properties<UpdateIndividualSinglesMatchInput>> = z.object({
    matchDate: z.string().nullish(),
    order: z.number().nullish(),
...
export const UpdateIndividualDoublesMatchInputSchema: z.ZodObject<Properties<UpdateIndividualDoublesMatchInput>> = z.object({
    matchDate: z.string().nullish(),
    order: z.number().nullish(),
    resultType: ResultTypeSchema.nullish(),
    score: z.string().nullish(),
...
export const CreateTennisLeagueInputSchema: z.ZodObject<Properties<CreateTennisLeagueInput>> = z.object({
    description: z.string().nullish(),
    endDate: z.string(),
    isActive: z.boolean().nullish(),
    name: z.string(),
...
export const CreateIndividualSinglesMatchInputSchema: z.ZodObject<Properties<CreateIndividualSinglesMatchInput>> = z.object({
    matchDate: z.string(),
    order: z.number(),
    player1Id: z.string(),
    player2Id: z.string(),
...
export const CreateIndividualDoublesMatchInputSchema: z.ZodObject<Properties<CreateIndividualDoublesMatchInput>> = z.object({
    matchDate: z.string(),
    order: z.number(),
    resultType: ResultTypeSchema.nullish(),
    score: z.string(),
